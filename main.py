        ...
        <body>
            <div class="card">
                ...
                <form action="/sync_data" method="post" style="text-align: center;">
                    <button type="submit" class="sync-btn">🔄 FORCE SYNC MEMBERS & CHANNELS</button>
                </form>
...
def sync_data():
    ...
    <html><body style="background:#0c0d0e; color:white; font-family:sans-serif; text-align:center; padding-top:100px;">
        ...
        <p>Discord is updating the member cache. Redirecting you back in 3 seconds...</p>
...
def execute():
    ...
    try:
        if action == "embed":
            ...
            return f"✅ Embed sent. <a href='/'>Back</a>"
